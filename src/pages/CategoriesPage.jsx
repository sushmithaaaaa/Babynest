...
export default function CategoriesPage({ products, cartItems, setCartItems, wishlist, setWishlist }) {
  const [selectedCategory, setSelectedCategory] = useState('clothing');
  const navigate = useNavigate();

  // Define 7 Standard Categories
  const categoriesListData = [
    { 
      ...
      description: '100% organic GOTS-certified cotton rompers, booties, and swaddle blankets.',
      itemsCount: 0 
    },
    { 
      id: 'toys', 
      ...
      description: 'Non-toxic, chemical-free wooden stackers, alphabet blocks, and hand-knits.',
      itemsCount: 0 
    },
    { 
      id: 'care', 
      ...
      description: 'Biodegradable bamboo eco wipes, grooming kits, and daily baby hygiene items.',
      itemsCount: 0 
    },
    { 
      id: 'feeding', 
      ...
      description: 'Food-grade silicone plate sets, deep pocket suction bibs, and training pacifiers.',
      itemsCount: 0 
    },
    { 
      id: 'diapers', 
      name: 'Diapers', 
      emoji: '🩲', 
      bgColor: 'bg-indigo-50 text-babyPurple-dark border-indigo-100',
      hoverBg: 'hover:bg-indigo-100',
      description: 'Eco-friendly disposable diapers, reusable bamboo cloth inserts, and changing mats.',
      itemsCount: 0 
    },
    { 
      id: 'furniture', 
      ...
      description: 'Convertible pine cribs, baby nursery fitted crib sheets, and cotton toy baskets.',
      itemsCount: 0 
    },
    { 
      id: 'accessories', 
      ...
      description: 'Lightweight aluminum travel strollers, diaper backpacks, and ergonomic carriers.',
      itemsCount: 0 
    }
  ];

  // Calculate counts dynamically from shared products
  categoriesListData.forEach(cat => {
    cat.itemsCount = products.filter(p => p.category === cat.id).length;
  });
  ...
  return (
    <div className="py-12 bg-gradient-to-b from-pink-50/10 via-white to-sky-50/10 min-h-screen selection:bg-pink-100 selection:text-pink-650">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {categoriesListData.map((category) => {
            ...
            return (
              <div
                ...
                className={`group flex flex-col p-6 rounded-[32px] border-2 cursor-pointer transition-all duration-300 relative overflow-hidden text-left bg-white ${
                  isActive 
                    ? 'border-babyPink bg-white shadow-xl shadow-pink-100 scale-105' 
                    : 'border-slate-100 hover:border-pink-200 hover:scale-[1.02] shadow-sm'
                }`}
              >
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-sm font-bold font-fredoka text-slate-800 group-hover:text-babyPink-dark transition-colors leading-tight">
                      {category.name}
                    </h3>
                ...
                <div className="flex items-center justify-between mt-auto">
                  <span className={`text-[10px] font-bold font-fredoka flex items-center gap-1 ${
        ...
        <div className="border-t border-slate-100 pt-16 mb-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 text-left">
          <div>
